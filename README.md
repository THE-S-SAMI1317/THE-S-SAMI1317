...
<body
    ...
    <section id="about" class="py-24 relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-minmax-180px-auto">
                <div class="md:col-span-2 lg:col-span-2 glass rounded-3xl p-8 spotlight-card" data-aos="fade-up">
                    <div class="h-full flex flex-col justify-center">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 leading-relaxed mb-6">I am a first-year Computer
                            Science Engineering student at AIUB with a perfect 4.00 CGPA. My journey is defined by a
                ...
                <div class="glass rounded-3xl p-6 flex flex-col items-center justify-center text-center spotlight-card group"
                    data-aos="fade-up" data-aos-delay="100">
                    <div
                        class="w-16 h-16 rounded-full bg-gradient-to-br from-green-400 to-emerald-600 flex items-center justify-center text-white text-2xl mb-4 group-hover:scale-110 transition-transform">
                        <i class="fas fa-graduation-cap"></i>
                    </div>
                    <h4 class="text-4xl font-bold dark:text-white">4.00</h4>
                    <p class="text-sm text-gray-500 uppercase tracking-wider mt-1">Current CGPA</p>
                </div>
                    ...
                    <div class="relative border-l-2 border-gray-700 ml-3 space-y-10">
                        <div class="relative pl-8 group">
                            ...
                            <div class="mt-2 text-sm font-bold text-green-400 flex items-center gap-2">
                                <i class="fas fa-star"></i>CGPA 4.00 / 4.00
                            </div>
                        </div>
                        <div class="relative pl-8 group">
                            <div
    ...
    <section id="works" class="py-24 bg-light/50 dark:bg-dark/50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="group relative bg-white dark:bg-[#111] rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 transition-all hover:shadow-2xl hover:border-primary/50 tilt-card"
                    data-aos="fade-up">
                    <div class="h-64 overflow-hidden relative bg-gray-900">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent z-10 opacity-60">
                        </div>
                        <div
                            class="w-full h-full flex items-center justify-center bg-gradient-to-br from-indigo-900 to-purple-900 group-hover:scale-105 transition-transform duration-700">
                            <i
                                class="fas fa-hospital-user text-6xl text-white/20 group-hover:text-white/40 transition-colors"></i>
                        </div>
                    </div>
                    <div class="absolute top-4 left-4 z-20 flex gap-2">
                        <span
                            class="px-2 py-1 bg-black/50 backdrop-blur-md border border-white/10 rounded text-10px font-mono text-white">JAVA
                            SWING</span>
                        <span
                            class="px-2 py-1 bg-black/50 backdrop-blur-md border border-white/10 rounded text-10px font-mono text-white">JSON</span>
                    </div>

                    <div class="p-8 relative z-20 bg-white dark:bg-[#111]">
                        <h3 class="text-2xl font-bold dark:text-white mb-2 group-hover:text-primary transition-colors">
                            Healthcare Center</h3>
                        <p class="text-gray-500 dark:text-gray-400 text-sm mb-6 line-clamp-2">A comprehensive desktop
                            application designed to digitize healthcare operations, streamlining patient management and
                            blood bank inventory.</p>
                        <div class="flex justify-between items-center">
                            <button onclick="openModal('modal1')"
                                class="text-sm font-bold flex items-center gap-2 dark:text-white hover:gap-3 transition-all">
                                Case Study
    ...
    <!-- Project Modal -->
    <div id="projectModal" class="fixed inset-0 z-60 hidden transition-opacity duration-300 opacity-0">
        <div class="absolute inset-0 bg-black/90 backdrop-blur-sm" onclick="closeModal()"></div>
        <div
            class="absolute top-12 left-12 transform -translate-x-12 -translate-y-12 bg-white dark:bg-[#0f1115] w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-800 m-4">
            <div id="modalContent"></div>
            <button onclick="closeModal()"
                class="absolute top-4 right-4 z-50 text-white bg-black/50 w-8 h-8 rounded-full flex items-center justify-center hover:bg-red-500 transition-colors">
    ...
    <script>
        ...
        const modalData = {
            modal1: {
                ...
                desc: 'A robust Java Swing application for hospital management.',
                features: ['Patient Database', 'Blood Bank API', 'Doctor Scheduling', 'Appointment System'],
                tech: ['Java', 'OOP', 'Swing', 'JSON']
            }
        };
        ...
        function openModal(id) {
            ...
            content.innerHTML = `
                ...
                <div class="p-8">
                    <h3 class="text-2xl font-bold dark:text-white mb-2">${data.title}</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-4">${data.desc}</p>
                    <div class="flex gap-2 flex-wrap mb-6">
                        ${data.tech.map(t => `<span class="px-2 py-1 bg-gray-100 dark:bg-gray-800 dark:text-white rounded text-xs font-mono border dark:border-gray-700">${t}</span>`).join('')}
                    </div>
                    <a href="https://github.com/THE-S-SAMI1317" target="_blank" class="block w-full text-center py-3 bg-primary text-white font-bold rounded hover:bg-secondary transition-colors">View Source</a>
                </div>
            `;
